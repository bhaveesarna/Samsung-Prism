...
f = open("./samples/sample1.cc",'r+')
lines = [line.strip() for line in f.readlines()]
lines = [line for line in lines if not line.startswith("//") and not line.startswith("#include")]
blank_var = " ".join(lines)
print("INPUT FILE:\n", blank_var)
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
